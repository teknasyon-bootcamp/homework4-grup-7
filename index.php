    ...
    <tbody>
      ...
      if(isset($_GET['post'])){
        ...
        foreach($post as $post_val){
          ...
          echo "<td><a href='http://localhost/homework4-grup7/$post_val[post_header]'> $post_val[post_header]</a></td>" . PHP_EOL;
        ...
        foreach($posts as $post){
          ...
          echo "<td><a href='http://localhost/homework4-grup7/$post[post_header]'> $post[post_header]</a></td>" . PHP_EOL;
