...
class Post{
    ...
    public string $post_created;
    public string $post_updated;
    */
...
//$postList = $post->postLists(); Tüm postları çeker
//$post_detail = $post->postDetail(2); Parametre olarak verilen id deki postu çeker
